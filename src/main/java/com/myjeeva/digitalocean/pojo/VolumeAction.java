...
public class VolumeAction {
	 ...
	 *
	 * @param type
	 *             action type of the volume
	 * @param dropletId
	 *             is to attach/detach volume from droplet
	 * @param regionSlug
	 *             short name of region
	 */
	public VolumeAction(ActionType type, String dropletId, String regionSlug) {
	 ...
	 *             volume size in GB
	 */
	public VolumeAction(ActionType type, String dropletId, String regionSlug, String volumeName, Double size) {
		this.type = type;
